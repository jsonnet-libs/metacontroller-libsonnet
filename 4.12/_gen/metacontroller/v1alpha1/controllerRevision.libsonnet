{
  ...
  '#':: d.pkg(name='controllerRevision', url='', help='"ControllerRevision"'),
  '#children':: d.obj(help=''),
  children: {
  ...
  '#withChildren':: d.fn(help='', args=[d.arg(name='children', type=d.T.array)]),
  withChildren(children): { children: if std.isArray(v=children) then children else [children] },
  '#withChildrenMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='children', type=d.T.array)]),
  withChildrenMixin(children): { children+: if std.isArray(v=children) then children else [children] },
  '#withParentPatch':: d.fn(help='', args=[d.arg(name='parentPatch', type=d.T.object)]),
  withParentPatch(parentPatch): { parentPatch: parentPatch },
  '#withParentPatchMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parentPatch', type=d.T.object)]),
  withParentPatchMixin(parentPatch): { parentPatch+: parentPatch },
  '#mixin': 'ignore',
  mixin: self,
}
